...
class Sec3 extends React.Component{
    render(){
        return<div>
            ...
            <Header style={{fontSize:70, position:'absolute', top:1600.5, left:1125.5, color:'white'}}>
            Project 
            </Header>
            <br/>
            <Header style={{fontSize:50, position:'absolute', top:1700.5, left:1125.5, color:'white'}}>
            SCAR
            </Header>
            <br />
            
            <Icon name='arrow right' size='huge' inverted style={{position:'absolute', top:1850, left:1125.5}} />
            </Link>
            </div>
