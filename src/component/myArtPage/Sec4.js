...
class Sec4 extends React.Component{
    render(){
        return<div>
            ...
            <Header style={{fontSize:70, position:'absolute', top:2455, left:410, color:'white'}}>
            Project 4 Dystopia
            </Header>
            
            <Icon name='arrow right' size='huge' inverted style={{position:'absolute', top:2465, left:1269}} />
            </Link>
            </div>
